...
#include "cpp_srvcli/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddTwoInts_Request__ros_msg_type = cpp_srvcli__srv__AddTwoInts_Request;
...
size_t get_serialized_size_cpp_srvcli__srv__AddTwoInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddTwoInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_srvcli__srv__AddTwoInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_srvcli
size_t max_serialized_size_cpp_srvcli__srv__AddTwoInts_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cpp_srvcli__srv__AddTwoInts_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_srvcli, srv, AddTwoInts_Request)() {
...
using _AddTwoInts_Response__ros_msg_type = cpp_srvcli__srv__AddTwoInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_srvcli
size_t get_serialized_size_cpp_srvcli__srv__AddTwoInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddTwoInts_Response__ros_msg_type * ros_message = static_cast<const _AddTwoInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cpp_srvcli__srv__AddTwoInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_srvcli
size_t max_serialized_size_cpp_srvcli__srv__AddTwoInts_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cpp_srvcli__srv__AddTwoInts_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_srvcli, srv, AddTwoInts_Response)() {
...
// already included above
// #include "cpp_srvcli/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cpp_srvcli/srv/add_two_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cpp_srvcli, srv, AddTwoInts)() {

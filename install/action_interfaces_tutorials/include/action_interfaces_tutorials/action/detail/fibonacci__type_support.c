...
#include <stddef.h>
#include "action_interfaces_tutorials/action/detail/fibonacci__rosidl_typesupport_introspection_c.h"
#include "action_interfaces_tutorials/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_Goal__init(message_memory);
}

void Fibonacci_Goal__rosidl_typesupport_introspection_c__Fibonacci_Goal_fini_function(void * message_memory)
{
  action_interfaces_tutorials__action__Fibonacci_Goal__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_Goal__rosidl_typesupport_introspection_c__Fibonacci_Goal_message_member_array[1] = {
  {
    ...
    offsetof(action_interfaces_tutorials__action__Fibonacci_Goal, order),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_Goal__rosidl_typesupport_introspection_c__Fibonacci_Goal_message_members = {
  "action_interfaces_tutorials__action",  // message namespace
  "Fibonacci_Goal",  // message name
  1,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_Goal),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_Result__init(message_memory);
}

void Fibonacci_Result__rosidl_typesupport_introspection_c__Fibonacci_Result_fini_function(void * message_memory)
{
  action_interfaces_tutorials__action__Fibonacci_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_Result__rosidl_typesupport_introspection_c__Fibonacci_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_Result, sequence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_Result__rosidl_typesupport_introspection_c__Fibonacci_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_Feedback__init(message_memory);
}

void Fibonacci_Feedback__rosidl_typesupport_introspection_c__Fibonacci_Feedback_fini_function(void * message_memory)
{
  action_interfaces_tutorials__action__Fibonacci_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_Feedback__rosidl_typesupport_introspection_c__Fibonacci_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_Feedback, partial_sequence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_Feedback__rosidl_typesupport_introspection_c__Fibonacci_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_Feedback)() {
...
// Member `goal`
#include "action_interfaces_tutorials/action/fibonacci.h"
// Member `goal`
// already included above
// #include "action_interfaces_tutorials/action/detail/fibonacci__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_SendGoal_Request__init(message_memory);
}
...
{
  action_interfaces_tutorials__action__Fibonacci_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_SendGoal_Request__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_SendGoal_Request__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_SendGoal_Response__init(message_memory);
}
...
{
  action_interfaces_tutorials__action__Fibonacci_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_SendGoal_Response__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_SendGoal_Response__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_members = {
  "action_interfaces_tutorials__action",  // service namespace
  "Fibonacci_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_type_support_handle = {
  0,
  &action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_SendGoal)() {
  if (!action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_type_support_handle.typesupport_identifier) {
    action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_SendGoal_Response)()->data;
  }

  return &action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_GetResult_Request__init(message_memory);
}
...
{
  action_interfaces_tutorials__action__Fibonacci_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_GetResult_Request__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_GetResult_Request__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_GetResult_Response__init(message_memory);
}
...
{
  action_interfaces_tutorials__action__Fibonacci_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_GetResult_Response__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_GetResult_Response__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_members = {
  "action_interfaces_tutorials__action",  // service namespace
  "Fibonacci_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_type_support_handle = {
  0,
  &action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_GetResult)() {
  if (!action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_type_support_handle.typesupport_identifier) {
    action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_GetResult_Response)()->data;
  }

  return &action_interfaces_tutorials__action__detail__fibonacci__rosidl_typesupport_introspection_c__Fibonacci_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  action_interfaces_tutorials__action__Fibonacci_FeedbackMessage__init(message_memory);
}
...
{
  action_interfaces_tutorials__action__Fibonacci_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Fibonacci_FeedbackMessage__rosidl_typesupport_introspection_c__Fibonacci_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces_tutorials__action__Fibonacci_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Fibonacci_FeedbackMessage__rosidl_typesupport_introspection_c__Fibonacci_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(action_interfaces_tutorials__action__Fibonacci_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_action_interfaces_tutorials
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces_tutorials, action, Fibonacci_FeedbackMessage)() {
